...
const Skills = () => {
  ...
  return (
    <div className='skills-container px-6 grid justify-center relative'>
      ...
      <div className='absolute rounded-full w-10 h-10 bg-white -right-3 top-8 filter blur-xl md:right-24 md:-top-24 md:w-32 md:h-32 opacity-40'></div>
    </div>
  );
};
